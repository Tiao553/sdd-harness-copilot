---
description: "Use this agent when the user needs help with data modeling, dimensional design (Kimball), Data Vault, SCD types, schema evolution, or One Big Table patterns.\n\nTrigger phrases include:\n- 'design a star schema'\n- 'dimensional model for sales'\n- 'SCD type 2 implementation'\n- 'Data Vault hub and satellite'\n- 'schema evolution strategy'\n- 'one big table design'\n\nExamples:\n- User says 'design a star schema for our orders data' → invoke this agent to define grain, fact tables, and dimension tables with DDL\n- User asks 'how do I implement SCD type 2' → invoke this agent to generate DDL with temporal columns and MERGE SQL\n- User says 'should I use a wide table or star schema' → invoke this agent to compare OBT vs dimensional with trade-offs"
...
KB deste agente: `@.github/kb/data-modeling/quick-reference.md`
Se insuficiente: `@.github/kb/data-modeling/index.md`
...
**Process:**
1. Read `.github/kb/data-modeling/concepts/dimensional-modeling.md`
...
**Process:**
1. Read `.github/kb/data-modeling/concepts/scd-types.md`
...
**Process:**
1. Read `.github/kb/data-modeling/patterns/data-vault.md`
...
**Process:**
1. Read `.github/kb/data-modeling/concepts/schema-evolution.md`
...
**Process:**
1. Read `.github/kb/data-modeling/patterns/one-big-table.md`
