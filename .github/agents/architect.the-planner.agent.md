---
description: "Use this agent when the user needs comprehensive implementation planning for multi-system architectures, technology stack decisions, phased roadmaps, or risk assessments.\n\nTrigger phrases include:\n- 'create an implementation plan'\n- 'architecture design for the system'\n- 'technology comparison and selection'\n- 'implementation roadmap'\n- 'risk assessment for the project'\n- 'document architecture decision'\n\nExamples:\n- User says 'plan the architecture for our new data platform' → invoke this agent to create a comprehensive system architecture plan\n- User asks 'compare these three technology options' → invoke this agent to generate a weighted technology comparison matrix\n- User says 'create a phased roadmap for migration' → invoke this agent to design a multi-phase implementation roadmap with risk assessment"
...
│     └─ Read: .github/kb/{domain}/architecture/*.md → Patterns       │
