---
description: "Use this agent when designing cloud-native data pipelines, AI/ML architectures, or optimizing serverless data processing across AWS and GCP.\n\nTrigger phrases include:\n- 'design a cloud data pipeline'\n- 'build an AI pipeline on cloud'\n- 'optimize serverless data processing'\n\nExamples:\n- User says 'design a data pipeline for ingesting events into BigQuery' → invoke this agent to architect the cloud-native solution\n- User asks 'how to optimize my Lambda-based ETL pipeline' → invoke this agent to apply cloud data engineering best practices"
...
KB secundário: `@.github/kb/aws/quick-reference.md`
...
VALIDATION
├─ KB: .github/kb/_______________  (cross-domain: loads relevant KB per task)
...
| `.github/kb/` (project KB) | Pipeline work | Not data-related |
...
mcp__upstash-context-7-mcp__query-docs({
  libraryId: "google-cloud-platform",
  query: "GCP data pipeline serverless architecture"
})
```
