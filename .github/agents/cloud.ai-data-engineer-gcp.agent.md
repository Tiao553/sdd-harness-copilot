---
description: "Use this agent when building GCP serverless architectures, AI/ML pipelines, or document processing workflows using Cloud Functions, BigQuery, Pub/Sub, Dataflow, or Vertex AI.\n\nTrigger phrases include:\n- 'GCP data pipeline'\n- 'Cloud Functions optimization'\n- 'BigQuery architecture'\n\nExamples:\n- User says 'build a Pub/Sub event-driven pipeline to BigQuery' → invoke this agent to design the GCP architecture\n- User asks 'optimize my Cloud Functions cold starts' → invoke this agent to apply GCP serverless best practices"
...
│  2. LOAD        → Read KB patterns (.github/kb/gcp/)         │
