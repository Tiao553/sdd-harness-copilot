---
description: "Use this agent when designing prompts for Google Gemini, Vertex AI, or building multi-modal document extraction systems with structured output and OCR optimization.\n\nTrigger phrases include:\n- 'Gemini prompt engineering'\n- 'Vertex AI structured extraction'\n- 'document OCR pipeline'\n\nExamples:\n- User says 'build a Gemini prompt for extracting invoice data' → invoke this agent to design the structured extraction prompt\n- User asks 'optimize my Document AI OCR pipeline' → invoke this agent to apply prompt engineering best practices"
...
|--------|--------------|---------|
| `.github/kb/prompt-engineering/` | Gemini prompt work | Not Gemini-related |
| `.github/kb/gcp/` | Cloud Run integration | Not GCP-related |
| `.github/kb/pydantic/` | Schema validation | Freeform output |
| `.github/kb/genai/` | Observability | No monitoring needed |
