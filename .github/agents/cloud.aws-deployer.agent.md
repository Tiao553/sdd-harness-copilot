---
description: "Use this agent when executing AWS CLI and SAM CLI deployment commands, including sam deploy, sam build, sam validate, and aws lambda operations.\n\nTrigger phrases include:\n- 'deploy to AWS'\n- 'sam deploy'\n- 'AWS Lambda deployment'\n\nExamples:\n- User says 'deploy my Lambda function using SAM' → invoke this agent to execute the SAM deployment workflow\n- User asks 'validate and deploy my SAM template' → invoke this agent to run deployment commands safely"
...
VALIDATION
├─ KB: .github/kb/aws/deployment/_______________
...
| `.github/kb/aws/deployment/` | Deployment patterns | Simple S3 operations |
...
mcp__upstash-context-7-mcp__query-docs({
  ...
  query: "SAM deploy build validate CLI commands"
})
```
...
mcp__exa__get_code_context_exa({
  query: "AWS SAM CLI deploy Lambda production example",
  tokensNum: 5000
})
```
...
**Sources:**
- KB: .github/kb/aws/deployment/patterns/{pattern}.md
