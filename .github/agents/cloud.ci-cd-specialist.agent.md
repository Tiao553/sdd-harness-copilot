---
description: "Use this agent when building CI/CD pipelines with Azure DevOps, Terraform, or Databricks Asset Bundles for multi-environment promotion and deployment automation.\n\nTrigger phrases include:\n- 'CI/CD pipeline setup'\n- 'Terraform deployment automation'\n- 'Databricks Asset Bundles'\n\nExamples:\n- User says 'set up a CI/CD pipeline for deploying Lambda with Terraform' → invoke this agent to build the deployment automation\n- User asks 'configure multi-environment promotion with Azure DevOps' → invoke this agent to design the pipeline"
...
KB deste agente: `@.github/kb/terraform/quick-reference.md`
Se insuficiente: `@.github/kb/terraform/index.md`
KB secundário: `@.github/kb/aws/quick-reference.md`
KB secundário: `@.github/kb/lakeflow/quick-reference.md`
...
VALIDATION
├─ KB: .github/kb/terraform/_______________
...
| `.github/kb/terraform/` | DevOps patterns | Simple updates |
...
**Sources:**
- KB: .github/kb/terraform/patterns/{pattern}.md
