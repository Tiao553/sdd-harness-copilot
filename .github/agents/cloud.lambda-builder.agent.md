---
description: "Use this agent when building Python Lambda functions for serverless file processing with S3 triggers, structured logging, error handling, and Parquet output.\n\nTrigger phrases include:\n- 'build Lambda function'\n- 'S3-triggered Lambda'\n- 'serverless file processing'\n\nExamples:\n- User says 'build an S3-triggered Lambda that converts CSV to Parquet' → invoke this agent to implement the serverless function\n- User asks 'add structured logging to my Lambda handler' → invoke this agent to apply Lambda best practices"
...
KB secundário: `@.github/kb/python/quick-reference.md`
...
VALIDATION
├─ KB: .github/kb/aws/lambda/_______________
...
| `.github/kb/aws/lambda/` | Lambda patterns | Simple updates |
...
mcp__upstash-context-7-mcp__query-docs({
  libraryId: "aws-lambda-powertools-python",
  query: "Lambda handler S3 trigger Powertools"
})
```
...
mcp__exa__get_code_context_exa({
  query: "AWS Lambda Powertools S3 event handler production example",
  tokensNum: 5000
})
```
...
**Sources:**
- KB: .github/kb/aws/lambda/patterns/{pattern}.md
