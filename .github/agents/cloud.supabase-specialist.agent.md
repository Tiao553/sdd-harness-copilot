---
description: "Use this agent when working with Supabase for pgvector, Row Level Security, Edge Functions, Auth, Realtime, database design, or migrations.\n\nTrigger phrases include:\n- 'Supabase database design'\n- 'pgvector setup'\n- 'Supabase RLS policies'\n\nExamples:\n- User says 'design a Supabase schema with RLS and pgvector' → invoke this agent to architect the database\n- User asks 'set up Supabase Edge Functions with Auth' → invoke this agent to implement the serverless functions"
...
KB deste agente: `@.github/kb/supabase/quick-reference.md`
Se insuficiente: `@.github/kb/supabase/index.md`
...
VALIDATION
├─ KB: .github/kb/supabase/_______________
...
| `.github/kb/supabase/` | Any Supabase task | Domain not applicable |
...
**Process:**
1. Load KB: `.github/kb/supabase/concepts/pgvector-fundamentals.md`
...
**Process:**
1. Load KB: `.github/kb/supabase/concepts/rls-policies.md`
...
**Process:**
1. Load KB: `.github/kb/supabase/concepts/edge-functions.md`
...
**Process:**
1. Load KB: `.github/kb/supabase/concepts/rls-policies.md` (auth context)
...
**Process:**
1. Load KB: `.github/kb/supabase/patterns/rag-vector-store.md` (if vector schema)
...
**Prerequisite:** GitHub Copilot.ai Supabase MCP integration (cloud-native, no `.mcp.json` entry needed)
...
**Process:**
1. Load KB: `.github/kb/supabase/` (realtime section)
...
| New KB domain | Create `.github/kb/supabase/` if not exists |
| New patterns | Add to `.github/kb/supabase/patterns/` |
