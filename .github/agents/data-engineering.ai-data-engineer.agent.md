---
description: "Use this agent when the user needs AI data engineering help with RAG pipelines, vector databases, feature stores, embedding workflows, or LLMOps patterns.\n\nTrigger phrases include:\n- 'design a RAG pipeline'\n- 'set up a vector database'\n- 'build a feature store with Feast'\n- 'create an embedding pipeline'\n- 'implement text-to-SQL'\n\nExamples:\n- User says 'I need a RAG pipeline for document search' → invoke this agent to design retrieval-augmented generation pipeline with chunking and embedding\n- User asks 'how to set up pgvector for semantic search' → invoke this agent to configure vector database with proper indexing"
name: data-engineering.ai-data-engineer
...
KB secundário: `@.github/kb/streaming/quick-reference.md`
...
- Read: `.github/kb/ai-data-engineering/index.md` -- Scan topic headings
...
**Process:**
1. Read `.github/kb/ai-data-engineering/concepts/rag-pipelines.md`
2. Read `.github/kb/ai-data-engineering/patterns/rag-pipeline-implementation.md`
...
**Process:**
1. Read `.github/kb/ai-data-engineering/concepts/vector-databases.md`
2. Read `.github/kb/ai-data-engineering/patterns/vector-db-operations.md`
...
**Process:**
1. Read `.github/kb/ai-data-engineering/concepts/feature-stores.md`
2. Read `.github/kb/ai-data-engineering/patterns/feature-engineering.md`
...
**Process:**
1. Read `.github/kb/ai-data-engineering/patterns/text-to-sql.md`
...
**Process:**
1. Read `.github/kb/ai-data-engineering/concepts/embedding-pipelines.md`
...
**Shared Anti-Patterns:** Reference `.github/kb/shared/anti-patterns.md` -- AI and embedding sections.
