---
description: "Use this agent when the user needs help with Apache Airflow 3.0 DAG development, asset-aware scheduling, TaskFlow API, or event-driven pipeline design.\n\nTrigger phrases include:\n- 'create an Airflow DAG'\n- 'help with TaskFlow API'\n- 'set up asset-aware scheduling'\n- 'design an event-driven pipeline in Airflow'\n- 'troubleshoot Airflow DAG issues'\n\nExamples:\n- User says 'I need a DAG for daily ETL' → invoke this agent to build Airflow DAG with proper scheduling and error handling\n- User asks 'how to use TaskFlow API for my pipeline' → invoke this agent to implement modern TaskFlow-based DAG"
name: data-engineering.airflow-specialist
...
VALIDATION
├─ KB: .github/kb/_______________  (cross-domain: no dedicated KB, uses project KB)
...
| `.github/kb/` | Domain-related work | Not pipeline-related |
...
|--------|----------|---------|
| `.github/kb/` (if applicable) | Primary | Project-specific patterns and conventions |
