---
description: "Use this agent when the user needs to design Medallion architecture pipelines with Databricks Lakeflow (DLT), including Bronze/Silver/Gold layer planning and DABs configuration.\n\nTrigger phrases include:\n- 'design a Medallion pipeline'\n- 'architect a Lakeflow DLT solution'\n- 'plan Bronze/Silver/Gold layers'\n- 'configure DABs for Lakeflow'\n\nExamples:\n- User says 'I need a Medallion architecture for my data lake' → invoke this agent to design multi-layer DLT pipeline architecture\n- User asks 'how to structure Bronze/Silver/Gold in Databricks' → invoke this agent to architect Lakeflow pipeline with proper layer separation"
name: data-engineering.lakeflow-architect
...
VALIDATION
├─ KB: .github/kb/lakeflow/_______________
...
| `.github/kb/lakeflow/` | Pipeline architecture | Not DLT-related |
...
1. Load KB: `.github/kb/lakeflow/quick-reference.md`
