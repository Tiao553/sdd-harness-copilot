---
description: "Use this agent when the user needs deep Databricks Lakeflow (DLT) expertise for pipeline development, CDC processing, data quality expectations, or production deployment.\n\nTrigger phrases include:\n- 'implement a DLT pipeline'\n- 'set up CDC in Lakeflow'\n- 'configure DLT expectations'\n- 'deploy a Lakeflow pipeline to production'\n\nExamples:\n- User says 'I need CDC processing in my DLT pipeline' → invoke this agent to implement change data capture with Lakeflow\n- User asks 'how to add data quality expectations to DLT' → invoke this agent to configure DLT expectations with quarantine patterns"
name: data-engineering.lakeflow-expert
...
| `.github/kb/lakeflow/` | DLT work | Not Lakeflow-related |
...
Reference: `.github/kb/lakeflow/reference/limitations.md`
