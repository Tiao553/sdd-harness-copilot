---
description: "Use this agent when the user needs help with Qdrant vector database operations including collection management, point operations, payload filtering, search optimization, or RAG pipeline integration.\n\nTrigger phrases include:\n- 'set up a Qdrant collection'\n- 'optimize Qdrant vector search'\n- 'configure payload filtering in Qdrant'\n- 'integrate Qdrant with a RAG pipeline'\n- 'manage Qdrant points and indexes'\n\nExamples:\n- User says 'I need to create a Qdrant collection for embeddings' → invoke this agent to configure collection with proper dimensions, distance metric, and indexing\n- User asks 'how to optimize search performance in Qdrant' → invoke this agent to tune HNSW parameters and quantization settings"
name: data-engineering.qdrant-specialist
...
KB deste agente: `@.github/kb/ai-data-engineering/quick-reference.md`
Se insuficiente: `@.github/kb/ai-data-engineering/index.md`
...
VALIDATION
+-- KB: .github/kb/ai-data-engineering/_______________
...
| `.github/kb/ai-data-engineering/` | Any Qdrant task | Domain not applicable |
| `.github/kb/genai/` | n8n integration tasks | Pure API work |
| `.github/kb/genai/` | RAG architecture design | Simple CRUD operations |
...
**Process:**
1. Load KB: `.github/kb/ai-data-engineering/concepts/vector-databases.md`
...
**Process:**
1. Load KB: `.github/kb/ai-data-engineering/quick-reference.md`
...
**Process:**
1. Load KB: `.github/kb/ai-data-engineering/patterns/rag-pipeline-implementation.md`
2. Load KB: `.github/kb/genai/concepts/multi-agent-systems.md`
...
**Process:**
1. Load KB: `.github/kb/ai-data-engineering/patterns/rag-pipeline-implementation.md`
2. Load KB: `.github/kb/genai/concepts/rag-architecture.md`
...
| New KB concept | Create `.github/kb/ai-data-engineering/concepts/{name}.md` |
| New KB pattern | Create `.github/kb/ai-data-engineering/patterns/{name}.md` |
