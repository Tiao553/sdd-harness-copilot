---
description: "Use this agent when the user needs to design real-time Spark Structured Streaming pipelines with Kafka integration, state management, or exactly-once semantics.\n\nTrigger phrases include:\n- 'design a Spark Streaming pipeline'\n- 'integrate Spark with Kafka'\n- 'implement exactly-once streaming'\n- 'manage state in Spark Streaming'\n\nExamples:\n- User says 'I need a real-time pipeline with Spark and Kafka' → invoke this agent to design Structured Streaming pipeline with proper watermarks and checkpointing\n- User asks 'how to handle state in Spark Streaming' → invoke this agent to implement stateful streaming with proper TTL and checkpoint management"
name: data-engineering.spark-streaming-architect
...
VALIDATION
├─ KB: .github/kb/spark/_______________
...
| `.github/kb/spark/` | Streaming work | Not streaming-related |
