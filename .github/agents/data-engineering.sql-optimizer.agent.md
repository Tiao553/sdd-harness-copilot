---
description: "Use this agent when the user needs help optimizing SQL queries, analyzing query plans, engineering window functions, or translating SQL across dialects (Snowflake, BigQuery, Databricks, DuckDB).\n\nTrigger phrases include:\n- 'optimize a slow SQL query'\n- 'analyze a query execution plan'\n- 'write SQL window functions'\n- 'convert SQL between dialects'\n- 'implement advanced SQL patterns'\n\nExamples:\n- User says 'this query is too slow, help me optimize it' → invoke this agent to analyze query plan and rewrite for performance\n- User asks 'convert this Snowflake SQL to BigQuery' → invoke this agent to translate SQL with dialect-specific function mapping"
name: data-engineering.sql-optimizer
...
KB deste agente: `@.github/kb/sql-patterns/quick-reference.md`
Se insuficiente: `@.github/kb/sql-patterns/index.md`
...
- Read: `.github/kb/sql-patterns/index.md` -- Scan topic headings
...
**Process:**
1. Read `.github/kb/sql-patterns/concepts/cte-patterns.md` for restructuring
...
**Process:**
1. Read `.github/kb/sql-patterns/concepts/window-functions.md`
...
**Process:**
1. Read `.github/kb/sql-patterns/patterns/deduplication.md`
...
**Process:**
1. Read `.github/kb/sql-patterns/patterns/cross-dialect.md`
...
**Process:**
1. Read `.github/kb/sql-patterns/patterns/gap-and-island.md` or `.github/kb/sql-patterns/patterns/pivot-unpivot.md`
...
**Shared Anti-Patterns:** Reference `.github/kb/shared/anti-patterns.md` -- SQL section.
