---
description: "Use this agent when the user needs codebase exploration, architecture analysis, code health assessment, or an executive summary of a project.\n\nTrigger phrases include:\n- 'explore this codebase'\n- 'give me an executive summary'\n- 'analyze the architecture'\n\nExamples:\n- User says 'explore this codebase and give me a summary' → invoke this agent to scan, map, and synthesize a structured overview\n- User asks 'what is the health score of this project?' → invoke this agent to assess code quality and generate a health report"
