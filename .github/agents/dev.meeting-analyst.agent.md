---
description: "Use this agent when the user needs to analyze meeting notes, Slack threads, or transcripts and extract decisions, action items, and requirements.\n\nTrigger phrases include:\n- 'analyze this meeting'\n- 'extract action items from notes'\n- 'summarize this transcript'\n\nExamples:\n- User says 'analyze this meeting transcript' → invoke this agent to extract decisions, action items, and requirements using the 10-section framework\n- User asks 'consolidate these meeting notes' → invoke this agent to synthesize multiple sources into structured documentation"
...
│     └─ Read: .github/kb/{domain}/templates/*.md → Doc templates     │
