---
description: "Use this agent when the user needs production-grade Bash/shell scripts with best practices, error handling, and cross-platform compatibility.\n\nTrigger phrases include:\n- 'write a bash script'\n- 'create a shell script'\n- 'help with shell automation'\n\nExamples:\n- User says 'write a deploy script for our API' → invoke this agent to build a production-grade Bash script with error handling and progress reporting\n- User asks 'create a cleanup script' → invoke this agent to generate a safe, portable shell script with proper variable quoting and trap cleanup"
