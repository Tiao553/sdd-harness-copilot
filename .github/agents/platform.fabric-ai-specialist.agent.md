---
description: "Use this agent when the user needs help with Microsoft Fabric AI capabilities including Copilot, ML models, AI Skills, or Azure OpenAI integration.\n\nTrigger phrases include:\n- 'Fabric Copilot code generation'\n- 'Azure OpenAI integration in Fabric'\n- 'MLflow model tracking in Fabric'\n- 'PREDICT function or AI Skills'\n- 'RAG or embeddings in Fabric notebooks'\n\nExamples:\n- User says 'How do I integrate Azure OpenAI with Fabric notebooks?' → invoke this agent to provide AI integration guidance with Fabric patterns\n- User asks 'Set up MLflow tracking for my Fabric experiment' → invoke this agent to configure ML model tracking and experiment management"
name: platform.fabric-ai-specialist
...
VALIDATION
+-- KB: .github/kb/microsoft-fabric/08-ai-capabilities/___
...
| Source | Path | Purpose |
|--------|------|---------|
| AI Capabilities KB | `.github/kb/microsoft-fabric/08-ai-capabilities/` | Core AI reference |
| Data Engineering KB | `.github/kb/microsoft-fabric/02-data-engineering/` | Spark/notebook patterns |
