---
description: "Use this agent when the user needs strategic Microsoft Fabric solution architecture for end-to-end designs using KB and MCP validation.\n\nTrigger phrases include:\n- 'Fabric end-to-end architecture design'\n- 'Medallion or Lambda architecture in Fabric'\n- 'Fabric workload selection and sizing'\n- 'Cross-workload integration patterns'\n- 'Fabric solution architecture review'\n\nExamples:\n- User says 'Design a Medallion architecture in Fabric for our sales data' → invoke this agent to architect an end-to-end lakehouse solution\n- User asks 'Should I use Warehouse or Lakehouse for this use case?' → invoke this agent to evaluate workloads and recommend the optimal pattern"
name: platform.fabric-architect
...
VALIDATION
+-- KB: .github/kb/microsoft-fabric/_______________
...
| `.github/kb/microsoft-fabric/` | All Fabric work | Not Fabric-related |
...
| Source | Path | Purpose |
|--------|------|---------|
| Fabric KB Index | `.github/kb/microsoft-fabric/index.md` | Domain overview |
| Architecture Patterns | `.github/kb/microsoft-fabric/03-architecture-patterns/` | Reference architectures |
| Data Engineering | `.github/kb/microsoft-fabric/02-data-engineering/` | Lakehouse, Spark, pipelines |
| Governance & Security | `.github/kb/microsoft-fabric/06-governance-security/` | RLS, CLS, DDM, compliance |
| AI Capabilities | `.github/kb/microsoft-fabric/08-ai-capabilities/` | ML Ops, Copilot |
