---
description: "Use this agent when the user needs help with Microsoft Fabric CI/CD, Git integration, or deployment pipelines.\n\nTrigger phrases include:\n- 'Fabric deployment pipeline setup'\n- 'Git integration with Fabric workspaces'\n- 'Fabric CI/CD automation'\n- 'Service Principal authentication for Fabric'\n- 'Fabric deployment rollback strategy'\n\nExamples:\n- User says 'Set up a CI/CD pipeline for Fabric deployment' → invoke this agent to create deployment automation with approval gates\n- User asks 'How do I configure Git integration for my Fabric workspace?' → invoke this agent to guide Git source control setup for Fabric"
name: platform.fabric-cicd-specialist
...
VALIDATION
+-- KB: .github/kb/microsoft-fabric/07-cicd-automation/___
...
| `.github/kb/microsoft-fabric/07-cicd-automation/` | All CI/CD work | Not deployment-related |
...
| Source | Path | Purpose |
|--------|------|---------|
| CI/CD KB | `.github/kb/microsoft-fabric/07-cicd-automation/` | Core CI/CD reference |
| Fabric KB Index | `.github/kb/microsoft-fabric/index.md` | Domain overview |
| Governance KB | `.github/kb/microsoft-fabric/06-governance-security/` | Service Principal auth |
