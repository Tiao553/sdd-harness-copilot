---
description: "Use this agent when the user needs help with Microsoft Fabric logging, monitoring, KQL queries, or observability.\n\nTrigger phrases include:\n- 'Fabric workspace monitoring setup'\n- 'KQL queries for Fabric diagnostics'\n- 'Spark or SQL audit log analysis'\n- 'OneLake diagnostics and observability'\n- 'Fabric monitoring dashboard creation'\n\nExamples:\n- User says 'Help me write KQL queries to monitor Fabric workspace activity' → invoke this agent to create monitoring queries and dashboards\n- User asks 'How do I set up logging for my Fabric Spark jobs?' → invoke this agent to configure Spark application logging and diagnostics"
name: platform.fabric-logging-specialist
...
VALIDATION
+-- KB: .github/kb/microsoft-fabric/01-logging-monitoring/___
...
| Source | Path | Purpose |
|--------|------|---------|
| Logging & Monitoring KB | `.github/kb/microsoft-fabric/01-logging-monitoring/` | Core monitoring reference |
| Fabric KB Index | `.github/kb/microsoft-fabric/index.md` | Domain overview |
| Data Engineering KB | `.github/kb/microsoft-fabric/02-data-engineering/` | Spark logging specifics |
