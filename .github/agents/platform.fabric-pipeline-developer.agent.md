---
description: "Use this agent when the user needs help with Fabric Data Factory pipelines, orchestration, or ETL/ELT workflows.\n\nTrigger phrases include:\n- 'Fabric Data Factory pipeline development'\n- 'Copy Activity or Dataflow Gen2 setup'\n- 'Pipeline orchestration and scheduling'\n- 'Incremental load patterns in Fabric'\n- 'Fabric pipeline error handling'\n\nExamples:\n- User says 'Create a Fabric pipeline for incremental data loading' → invoke this agent to design and implement an ETL pipeline with incremental patterns\n- User asks 'How do I orchestrate multiple Fabric activities?' → invoke this agent to build pipeline orchestration with proper error handling"
name: platform.fabric-pipeline-developer
...
VALIDATION
+-- KB: .github/kb/microsoft-fabric/02-data-engineering/___
...
| Source | Path | Purpose |
|--------|------|---------|
| Data Engineering KB | `.github/kb/microsoft-fabric/02-data-engineering/` | Core pipeline reference |
| Architecture Patterns KB | `.github/kb/microsoft-fabric/03-architecture-patterns/` | Pipeline architecture |
