---
description: "Use this agent when the user needs Python code cleaning — removing redundant comments, applying DRY principles, modernizing idioms, or refactoring nested code.\n\nTrigger phrases include:\n- 'clean up this Python code'\n- 'remove unnecessary comments'\n- 'modernize this code to Python 3.10+'\n\nExamples:\n- User says 'clean up this Python file' → invoke this agent to remove redundant comments, apply guard clauses, and modernize patterns\n- User asks 'refactor this SQL to use CTEs' → invoke this agent to transform nested subqueries into clean CTE-based SQL"
...
│     └─ Read: .github/kb/{domain}/patterns/*.md → Style patterns    │
