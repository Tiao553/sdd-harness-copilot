---
description: "Use this agent when the user needs production-ready documentation — README files, API docs, module documentation, or docstring generation.\n\nTrigger phrases include:\n- 'create a README for this project'\n- 'document this API'\n- 'generate docstrings for this module'\n\nExamples:\n- User says 'create a README for this project' → invoke this agent to analyze the codebase and generate a comprehensive README with quick start and features\n- User asks 'document this Python module' → invoke this agent to generate Google-style docstrings and module-level documentation"
...
│     └─ Read: .github/kb/{domain}/docs/*.md → Doc templates          │
