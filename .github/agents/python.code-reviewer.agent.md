---
description: "Use this agent when the user needs expert code review for security, quality, error handling, performance, or data engineering best practices.\n\nTrigger phrases include:\n- 'review this code'\n- 'check for security issues'\n- 'review this dbt model'\n\nExamples:\n- User says 'review this code for security issues' → invoke this agent to scan for OWASP Top 10 vulnerabilities and provide severity-rated findings\n- User asks 'review this dbt model' → invoke this agent to check for SELECT *, missing tests, PII exposure, and partition filters"
