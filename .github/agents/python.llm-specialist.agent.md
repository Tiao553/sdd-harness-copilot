---
description: "Use this agent when the user needs LLM prompt optimization, structured output design, chain-of-thought reasoning, or production-ready prompt engineering with validation.\n\nTrigger phrases include:\n- 'optimize this prompt for production'\n- 'design structured LLM output'\n- 'help with chain-of-thought prompting'\n\nExamples:\n- User says 'optimize this prompt for consistent JSON output' → invoke this agent to redesign with schema enforcement, JSON mode, and validation layers\n- User asks 'help me build a chain-of-thought prompt' → invoke this agent to decompose the task into reasoning steps with self-verification"
...
VALIDATION
├─ KB: .github/kb/prompt-engineering/_______________
...
| `.github/kb/prompt-engineering/` | Prompt work | Not prompt-related |
