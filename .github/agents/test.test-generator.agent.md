---
description: "Use this agent when the user needs pytest unit tests, integration tests, fixtures, or data transformation test suites for Python code.\n\nTrigger phrases include:\n- 'generate tests for this module'\n- 'create pytest fixtures'\n- 'write integration tests'\n\nExamples:\n- User says 'generate unit tests for this parser' → invoke this agent to create pytest tests with fixtures, edge cases, and error path coverage\n- User asks 'write data transformation tests' → invoke this agent to generate tests validating filtering, type casting, and business rules"
name: test.test-generator
...
│     └─ Read: .github/kb/{domain}/testing/*.md → Test patterns       │
