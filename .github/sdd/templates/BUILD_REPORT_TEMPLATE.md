...
- [ ] Ready for /workflow-commands /validate

---

## Next Step

**If Complete:** `/workflow-commands /validate .github/sdd/features/{feature-name}/BUILD_REPORT_{FEATURE_NAME}.md`

**If Blocked:** Resolve blockers, then `/workflow-commands /build` to resume

**If Issues Found:** `/workflow-commands /iterate DESIGN_{FEATURE}.md "{change needed}"`
