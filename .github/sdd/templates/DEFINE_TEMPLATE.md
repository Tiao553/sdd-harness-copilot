...
| **KB Domains** | {List domains from .github/kb/ relevant to this feature} | {Which patterns to consult} |
...
- **KB Domains** → Design phase pulls correct patterns from `.github/kb/`
...
**Ready for:** `/workflow-commands /design .github/sdd/features/{feature-name}/DEFINE_{FEATURE_NAME}.md`
