...
```text
# Active features
Glob(".github/sdd/features/BRAINSTORM_*.md")
Glob(".github/sdd/features/DEFINE_*.md")
Glob(".github/sdd/features/DESIGN_*.md")

# Build reports
Glob(".github/sdd/reports/BUILD_REPORT_*.md")

# Recently shipped
Glob(".github/sdd/archive/*")
```
...
| Documentation | {.github/copilot-instructions.md exists/missing}, {README.md exists/missing} | |
...
Detecting project health...
  47 test files, .github/copilot-instructions.md present, 12 TODOs
...
| Documentation | Present | .github/copilot-instructions.md and README.md both exist |
...
| `/sync-context` | Keep .github/copilot-instructions.md in sync after recent changes |
```
...
|---|---|---|
| Input check | Repositório Git válido com pelo menos 1 commit | Pare e reporte |
| SDD scan | Workspace `.github/sdd/` acessível (features e archive) | Pule seção SDD e alerte |
| Git state | Comandos git executam sem erro | Reporte e continue com dados parciais |
| Output check | Relatório gerado com todas as seções obrigatórias (Active Work, Health, Recommendations) | Reporte erro |
