...
|---|---|---|
| Input check | Repositório contém codebase analisável (pelo menos 1 arquivo fonte) | Pare e reporte |
| Preserve check | Seções manuais (Project Context, Important Dates) preservadas após merge | Aborte e restaure versão anterior |
| Template check | Arquivo gerado segue estrutura do template com todas as seções obrigatórias | Reporte erro |
| Output check | `.github/copilot-instructions.md` salvo com formatação Markdown válida | Reporte erro |
...
git commit -m "chore: update .github/copilot-instructions.md with latest project structure"
```
