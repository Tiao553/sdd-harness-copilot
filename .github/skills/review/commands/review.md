---
name: review
description: Dual AI code review with CodeRabbit + Antigravity for maximum coverage
---

# Review Command

> Dual AI code review with CodeRabbit + Antigravity for maximum coverage
...
**Reviewers:** CodeRabbit + Antigravity
...
|---|---|---|
| Input check | Repositório Git válido com pelo menos 1 alteração para revisar (uncommitted ou committed) | Pare e reporte |
| Diff check | Diff gerado com sucesso contra branch base (main ou especificada) | Reporte erro de Git |
| Review check | Relatório cobre ambas dimensões: análise estática (segurança, linting) e arquitetural (lógica, design) | Alerte sobre cobertura parcial |
| Output check | Relatório consolidado gerado com severidade classificada e seções obrigatórias | Reporte erro |

## Related

- Agent: `.github/agents/python.code-reviewer.agent.md`
- Config: `.coderabbit.yaml` (optional, create if needed)
- Create PR: `.github/skills/workflow-commands/commands/create-pr.md`
