...
Detailed prompt templates in `.github/skills/visual-explainer/commands/`. Invoke as `/visual-explainer /<command>` in GitHub Copilot.
...
**Usage:**
```bash
bash .github/skills/visual-explainer/scripts/share.sh <html-file>
```
...
See `.github/skills/visual-explainer/commands/share.md` for the `/share` command template.
