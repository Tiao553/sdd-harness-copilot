...
Generated with [Antigravity](https://claude.ai/code)
```
...
| `kb` | `.github/kb/**` |
| `sdd` | `.github/sdd/**` |
| `commands` | `.github/skills/workflow-commands/commands/**` |
...
- Review Command: `.github/skills/workflow-commands/commands/review.md`
- Code Reviewer Agent: `.github/agents/python.code-reviewer.md`
- Workflow: `.github/sdd/_index.md`
- Agents: `.github/agents/workflow.`
