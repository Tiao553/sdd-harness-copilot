...
/iterate .github/sdd/features/auth/DEFINE_AUTH.md "Change from JWT to session-based auth"
```
...
6. **Always Update Revision History** - Bump the version number on every iteration to maintain traceability
...
- Agent: `.github/agents/workflow.iterate-agent.agent.md`
